...
class Subway {
  ...
  constructor(start, dest) {
    const s = this.#LINE2.findIndex((a) => a === start);
    const d = this.#LINE2.findIndex((a) => a === dest);
    this.#line =
      d < s
        ? [...this.#LINE2.slice(s), ...this.#LINE2.slice(0, d + 1)]
        : this.#LINE2.slice(s, d + 1);
  ...
  [Symbol.iterator]() {
    ...
    return {
      next: () => {
        return { value: this.#line[idx++], done: idx > this.#line.length };
      },
    };
